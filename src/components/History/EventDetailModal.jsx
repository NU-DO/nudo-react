...
const EventDetailModal = ({ closeModal, tempState, handleChange, handleFileUpload, handleEditContact, modalSent, imageLoad, error }) => {
    ...
    return (
        <div className='ModalContent animate__animated animate__bounceInDown'>
            ...
            <form onSubmit={edit ? handleEditContact : modalSent}>
                <div className='EventDetailModalContainer'>
